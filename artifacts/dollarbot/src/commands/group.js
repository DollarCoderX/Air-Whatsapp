        ...
        try {
          ...
          await sock.sendMessage(jid, {
            text:
              ...
              `┃\n` +
              `┃ _Air Bot V6 — Protecting groups_\n` +
              `╰━━━━━━━━━━━━━━━━━━⬣`,
            mentions: [sender],
          });
        } catch (_) {}
...
const groupCommands = {
  ...
  // .antibot — kick any bot detected in the group except Air
  async antibot(sock, msg, args) {
    ...
    await send(sock, jid, msg,
      ...
      (setting === 'on'
        ? '_Any rival bot detected in this group (except Air) will be kicked automatically._'
        : 'Anti-bot disabled.')
    );
  },
