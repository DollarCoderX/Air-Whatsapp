...
const premiumCommands = {
  ...
  async searchgoogle(sock, msg, args) {
    ...
    try {
      ...
      let text = `🔍 *Air BOT GOOGLE SEARCH* 🔍\n\nQuery: _"${query}"_\n\n`;
