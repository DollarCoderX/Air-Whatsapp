...
/**
 * AI Tool-Calling (Agent Mode) for Air Bot
...
async function groqChat(messages, model = 'qwen/qwen3.8-27b') {
...
async function agent(sock, msg, args, jid) {
  ...
  const messages = [
    {
      role: 'system',
      content: `You are Air Agent, an AI assistant with access to real-world tools. 
