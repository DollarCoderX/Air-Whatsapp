...
function buildExifBuffer({ packname = 'Air Bot 💵', author = 'Dollar 🇨🇦' } = {}) {
  const json = {
    'sticker-pack-id': 'com.Air.stickers',
 ...
 */
async function imageToSticker(inputBuffer, packname = 'Air 💵', author = 'Dollar 🇨🇦') {
